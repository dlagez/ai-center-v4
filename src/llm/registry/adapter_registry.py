...
class AdapterRegistry:
    def __init__(self) -> None:
        self._adapters: dict[AccessMode, type[BaseModelAdapter]] = {}

    def register(self, adapter_cls: type[BaseModelAdapter]) -> None:
    ...
    def get(self, access_mode: AccessMode) -> type[BaseModelAdapter]:
        try:
